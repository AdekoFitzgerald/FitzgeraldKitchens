...
(defun gm1_Ust_Raf_Kural (inputH inputet / tempH) 
	(setq temph (- inputH ad_et ad_et))
	(cond
		((> inputH (cm2cu 200.0)) (gm1_createShelfDividList tempH inputet 6.0))
		((> inputH (cm2cu 155.0)) (gm1_createShelfDividList tempH inputet 5.0))
		((> inputH (cm2cu 120.0)) (gm1_createShelfDividList tempH inputet 4.0))
		((> inputH (cm2cu 95.0)) (gm1_createShelfDividList tempH inputet 3.0))
		((> inputH (cm2cu 65.0)) (gm1_createShelfDividList tempH inputet 2.0))
...
(defun gm1_Alt_Raf_Kural (inputH inputet / tempH) 
	(setq temph (- inputH ad_et ad_et))
	(cond
		((> inputH (cm2cu 120.0)) (gm1_createShelfDividList tempH inputet 3.0))
		((> inputH (cm2cu 75.0)) (gm1_createShelfDividList tempH inputet 2.0))
		((> inputH (cm2cu 50.0)) (gm1_createShelfDividList tempH inputet 1.0))
		(T nil)
	)
)
